  ...
  return (
    <Listbox value={selected} onChange={setSelected}>
      ...
      <div className="relative">
        <ListboxButton
          className="grid py-3 w-full cursor-default grid-cols-1 rounded-md bg-white 
       pr-2 pl-3 text-left text-gray-900 outline-1 -outline-offset-1 outline-gray-300 focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-indigo-600 sm:text-sm/6"
        >
